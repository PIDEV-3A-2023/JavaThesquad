...
public void redirect(ActionEvent e){
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GUI/AjouterCategorieLocationFXML.fxml"));
...
public void redirecttoupdate(ActionEvent e){
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GUI/ModifierCategorieLocationFXML.fxml"));
            newLoadedPane = loader.load();
