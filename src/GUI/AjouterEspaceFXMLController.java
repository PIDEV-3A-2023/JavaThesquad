...
private void ajoutEspace(ActionEvent event) {
    ...
    if (textfieldnom.getText().isEmpty() || dispo.getText().isEmpty() || textfieldadress.getText().isEmpty()
            || textfieldprix.getText().isEmpty() || imagetf.getText().isEmpty() || textareacarac.getText().isEmpty()) {
        Alert alert = new Alert(Alert.AlertType.WARNING);
        alert.setTitle("Champs vides");
        alert.setHeaderText(null);
        alert.setContentText("Veuillez remplir tous les champs.");
    ...
    Espace espace = new Espace(textfieldnom.getText(), textareacarac.getText(), imagetf.getText(),
